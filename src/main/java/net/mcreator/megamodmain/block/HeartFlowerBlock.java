...
import net.mcreator.megamodmain.procedures.HeartFlowerMobplayerCollidesWithPlantProcedure;
...
public class HeartFlowerBlock extends MegamodmainModElements.ModElement {
	@ObjectHolder("megamodmain:heart_flower")
	public static final Block block = null;
	public HeartFlowerBlock(MegamodmainModElements instance) {
		super(instance, 62);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.BEETROOT, (int) (1)));
		}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				HeartFlowerMobplayerCollidesWithPlantProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
