...
public class TerraStoneEBlock extends MegamodmainModElements.ModElement {
	@ObjectHolder("megamodmain:terra_stone_e")
	public static final Block block = null;
	public TerraStoneEBlock(MegamodmainModElements instance) {
		super(instance, 168);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("terra_stone_e", "terra_stone_e", blockAt -> {
