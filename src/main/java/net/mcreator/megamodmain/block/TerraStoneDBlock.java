...
public class TerraStoneDBlock extends MegamodmainModElements.ModElement {
	@ObjectHolder("megamodmain:terra_stone_d")
	public static final Block block = null;
	public TerraStoneDBlock(MegamodmainModElements instance) {
		super(instance, 167);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("terra_stone_d", "terra_stone_d", blockAt -> {
