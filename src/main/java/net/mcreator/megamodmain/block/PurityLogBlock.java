...
public class PurityLogBlock extends MegamodmainModElements.ModElement {
	@ObjectHolder("megamodmain:purity_log")
	public static final Block block = null;
	public PurityLogBlock(MegamodmainModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.35f, 3f).lightValue(0).harvestLevel(0)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("purity_log");
		}
