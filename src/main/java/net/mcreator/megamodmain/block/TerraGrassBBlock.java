...
public class TerraGrassBBlock extends MegamodmainModElements.ModElement {
	@ObjectHolder("megamodmain:terra_grass_b")
	public static final Block block = null;
	public TerraGrassBBlock(MegamodmainModElements instance) {
		super(instance, 169);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("terra_grass_b", "terra_grass_b", blockAt -> {
