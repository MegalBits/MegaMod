...
public class BuyGravelProcedure extends MegamodmainModElements.ModElement {
	public BuyGravelProcedure(MegamodmainModElements instance) {
		super(instance, 72);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure BuyGravel!");
			return;
		}
		...
		if (((new Object() {
			...
			if (((new Object() {
				...
				if (entity instanceof PlayerEntity) {
					ItemStack _setstack = new ItemStack(Blocks.GRAVEL, (int) (1));
