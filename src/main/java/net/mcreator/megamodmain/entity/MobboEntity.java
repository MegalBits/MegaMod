...
public class MobboEntity extends MegamodmainModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("megamodmain:entitybulletmobbo")
	public static final EntityType arrow = null;
	public MobboEntity(MegamodmainModElements instance) {
		super(instance, 75);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(999).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f)).build("mobbo")
						.setRegistryName("mobbo");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -3407668, -6750055, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("mobbo_spawn_egg"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletmobbo").setRegistryName("entitybulletmobbo"));
	}
