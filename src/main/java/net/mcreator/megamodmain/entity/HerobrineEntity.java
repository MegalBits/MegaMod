...
import net.mcreator.megamodmain.procedures.HerobrineOnEntityTickUpdateProcedure;
import net.mcreator.megamodmain.item.FireballSlingerItem;
...
public class HerobrineEntity extends MegamodmainModElements.ModElement {
	public static EntityType entity = null;
	public HerobrineEntity(MegamodmainModElements instance) {
		super(instance, 109);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(9999).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("megamodmain:textures/herobrine.png");
				}
			};
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, HerobrineEntity.CustomEntity.class, false, false));
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				HerobrineOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		...
		protected void registerAttributes() {
			...
			this.getAttribute(SharedMonsterAttributes.ATTACK_KNOCKBACK).setBaseValue(8D);
		}

		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			FireballSlingerItem.shoot(this, target);
		}
