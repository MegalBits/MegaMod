...
public class SteveEntity extends MegamodmainModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("megamodmain:steve_land")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("megamodmain:textures/steve.png");
				}
			};
	...
	public static class CustomEntity extends ZombieEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SteveEntity.CustomEntity.class, false, false));
