...
package net.mcreator.megamodmain.world.dimension;
...
import net.mcreator.megamodmain.item.StevelandsItem;
...
public class StevelandsDimension extends MegamodmainModElements.ModElement {
	@ObjectHolder("megamodmain:stevelands")
	public static final ModDimension dimension = null;
	@ObjectHolder("megamodmain:stevelands_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public StevelandsDimension(MegamodmainModElements instance) {
		super(instance, 45);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("stevelands"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("megamodmain:stevelands")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("megamodmain:stevelands"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("megamodmain:stevelands"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new StevelandsItem().setRegistryName("stevelands"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("stevelands_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = StevelandsDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos pos, Direction directionIn) {
				...
				return (this.world.getBlockState(framePos).getBlock() == Blocks.COBBLESTONE.getDefaultState().getBlock()) ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (!(this.world.getBlockState(framePos).getBlock() == Blocks.COBBLESTONE.getDefaultState().getBlock())) {
								break label56;
							}
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("stevelands_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "stevelands_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = StevelandsDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
			...
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, Blocks.COBBLESTONE.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
