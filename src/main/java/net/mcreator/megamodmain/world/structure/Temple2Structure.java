...
public class Temple2Structure extends MegamodmainModElements.ModElement {
	public Temple2Structure(MegamodmainModElements instance) {
		super(instance, 115);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 5000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("megamodmain", "temple2"));
						if (template == null)
							return false;
