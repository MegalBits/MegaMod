...
public class TerraTree3Structure extends MegamodmainModElements.ModElement {
	public TerraTree3Structure(MegamodmainModElements instance) {
		super(instance, 163);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 20000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("megamodmain", "terratree3"));
						if (template == null)
							return false;
