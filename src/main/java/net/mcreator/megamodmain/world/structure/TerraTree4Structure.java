...
public class TerraTree4Structure extends MegamodmainModElements.ModElement {
	public TerraTree4Structure(MegamodmainModElements instance) {
		super(instance, 164);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 20000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("megamodmain", "terratree4"));
						if (template == null)
							return false;
