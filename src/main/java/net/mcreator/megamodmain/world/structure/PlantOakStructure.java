...
public class PlantOakStructure extends MegamodmainModElements.ModElement {
	public PlantOakStructure(MegamodmainModElements instance) {
		super(instance, 68);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 15000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("megamodmain", "plant_oak"));
						if (template == null)
							return false;
