...
public class TerraTree1Structure extends MegamodmainModElements.ModElement {
	public TerraTree1Structure(MegamodmainModElements instance) {
		super(instance, 161);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 20000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("megamodmain", "terratree1"));
						if (template == null)
							return false;
