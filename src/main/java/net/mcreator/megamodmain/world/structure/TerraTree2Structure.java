...
public class TerraTree2Structure extends MegamodmainModElements.ModElement {
	public TerraTree2Structure(MegamodmainModElements instance) {
		super(instance, 162);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 20000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("megamodmain", "terratree2"));
						if (template == null)
							return false;
